...
<div class="divBoxContainer" style="width:94%">
	...
	<form name="frmBox" id="frmBox" class="frmBoxMain">
		...
		<fieldset class="ui-widget ui-widget-content ui-corner-all">
            ...
            <p>
                <label for="box-usuario_cambioclave">Ult. Cambio Clave ^</label>
                <input type="text" name="box-usuario_cambioclave" id="box-usuario_cambioclave" maxlength="19" class="ui-widget-content" style="width:220px" readonly="readonly" />
            </p>  
            <p>
                <label for="box-usuario_reseteado">Clave Reseteada ^</label>
                <input type="text" name="box-usuario_reseteado" id="box-usuario_reseteado" maxlength="2" class="ui-widget-content" style="width:220px" readonly="readonly" />
            </p>                                    
       </fieldset>            
        <!-- Acciones -->
        <p align="center" style="margin-top:20px">     
            <input type="hidden" name="box-usuario_id" id="box-usuario_id" />            
