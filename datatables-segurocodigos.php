...
<?php
	...
	$query_Recordset1_fields = " productor_seguro.productor_seguro_id as productor_seguro_id, productor_nombre, productor_seguro_organizacion_nombre, productor_seguro_codigo, GROUP_CONCAT(sucursal_nombre) as sucursal_nombre";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('productor_seguro_id', 'productor_nombre', 'productor_seguro_organizacion_nombre', 'productor_seguro_codigo', 'sucursal_nombre', ' ');
