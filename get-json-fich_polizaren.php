...
<?php
	...
	$query_Recordset1 = sprintf("SELECT poliza.poliza_id, sucursal_nombre, sucursal.sucursal_id, cliente_nombre, tipo_poliza_nombre, subtipo_poliza_nombre, poliza_numero AS poliza_renueva_num, productor_seguro.seguro_id, productor_seguro.productor_seguro_id, poliza_prima, poliza_premio, poliza_medio_pago, poliza_pago_detalle, poliza_ajuste, poliza_recargo, poliza_validez_hasta as poliza_validez_desde
