...
<?php
	...
	$query_Recordset1 = sprintf("SELECT poliza.poliza_id, sucursal_nombre, sucursal.sucursal_id, cliente_nombre, tipo_poliza_nombre, tipo_poliza.tipo_poliza_id as tipo_poliza_id, subtipo_poliza_nombre, poliza.subtipo_poliza_id as subtipo_poliza_id, poliza_numero AS poliza_renueva_num, poliza_vigencia, poliza_vigencia_dias, productor_seguro.seguro_id, productor_seguro.productor_seguro_id, poliza_prima, poliza_premio, poliza_medio_pago, poliza_pago_detalle, poliza_recargo, poliza_descuento, poliza_validez_hasta as poliza_validez_desde, poliza_flota
