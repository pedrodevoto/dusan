...
<?php
	if (isset($_POST["box-cliente_id"]) && $_POST["box-cliente_id"]!="") {
		...
		// Insert
		$insertSQL = sprintf("INSERT INTO contacto (contacto.cliente_id, contacto_tipo, contacto_domicilio, contacto_nro, contacto_piso, contacto_dpto, contacto_localidad, contacto_cp, contacto_country, contacto_lote, contacto_telefono1, contacto_telefono2, contacto_default) VALUES (%s, %s, UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), UPPER(TRIM(%s)), %s)",
