...
<?php
	if (!empty($_POST["box-siniestro_id"])) {
		$sql = sprintf('INSERT INTO siniestros_lesiones_terceros (siniestro_id) VALUES ("%s")', mysql_real_escape_string($_POST['box-siniestro_id']));
		mysql_query($sql, $connection) or die(mysql_error());
		
		$siniestros_lesiones_terceros_id = mysql_insert_id();
