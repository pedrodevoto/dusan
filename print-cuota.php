...
<?php
	...
	switch($row_Recordset1['subtipo_poliza_tabla']) {
		...
		case 'automotor':
			...
			$cuota_prox_venc = is_null($prox_cuota) ? date('d/m/Y', strtotime("+1 month", strtotime($row_Recordset1['cuota_vencimiento']))) : strftime("%d/%m/%Y", strtotime($prox_cuota['cuota_vencimiento']));
