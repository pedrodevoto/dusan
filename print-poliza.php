					...
					*****************************************/				
					...
					if (isset($_GET['email'])) {
						...
						switch(substr($_GET['type'], 2)) {
							...
							break;
							case 'en':
								$to = $row_Recordset1['seguro_email_endoso'];
