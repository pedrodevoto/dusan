...
<?php
	...
	switch($row_Recordset1['subtipo_poliza_tabla']) {
		...
		case 'combinado_familiar':
			...
			$upsertSQL = sprintf('INSERT INTO combinado_familiar (poliza_id, combinado_familiar_domicilio_calle, combinado_familiar_domicilio_nro, combinado_familiar_domicilio_piso, combinado_familiar_domicilio_dpto, combinado_familiar_domicilio_localidad, combinado_familiar_domicilio_cp, combinado_familiar_country, combinado_familiar_lote, combinado_familiar_valor_tasado, combinado_familiar_inc_edif, combinado_familiar_rc_lind,  combinado_familiar_cristales, combinado_familiar_responsabilidad_civil, combinado_familiar_danios_agua, combinado_familiar_jugadores_golf, combinado_familiar_inc_edif_flag, combinado_familiar_rc_lind_flag, combinado_familiar_tv_aud_vid_flag, combinado_familiar_obj_esp_prorrata_flag, combinado_familiar_equipos_computacion_flag, combinado_familiar_cristales_flag, combinado_familiar_responsabilidad_civil_flag, combinado_familiar_danios_agua_flag, combinado_familiar_jugadores_golf_flag, combinado_familiar_film_foto_flag, combinado_familiar_inc_mob, combinado_familiar_inc_mob_flag) 
						          VALUES (%1$s, UPPER(TRIM(%2$s)), UPPER(TRIM(%3$s)), UPPER(TRIM(%4$s)), UPPER(TRIM(%5$s)), UPPER(TRIM(%6$s)), UPPER(TRIM(%7$s)), UPPER(TRIM(%8$s)), UPPER(TRIM(%9$s)), %10$s, %11$s, %12$s, %13$s, %14$s, %15$s, %16$s, %17$s, %18$s, %19$s, %20$s, %21$s, %22$s, %23$s, %24$s, %25$s, %26$s, %27$s, %28$s) 
							  ON DUPLICATE KEY UPDATE combinado_familiar_domicilio_calle=UPPER(TRIM(%2$s)), combinado_familiar_domicilio_nro=UPPER(TRIM(%3$s)), combinado_familiar_domicilio_piso=UPPER(TRIM(%4$s)), combinado_familiar_domicilio_dpto=UPPER(TRIM(%5$s)), combinado_familiar_domicilio_localidad=UPPER(TRIM(%6$s)), combinado_familiar_domicilio_cp=UPPER(TRIM(%7$s)), combinado_familiar_country=UPPER(TRIM(%8$s)), combinado_familiar_lote=UPPER(TRIM(%9$s)), combinado_familiar_valor_tasado=%10$s, combinado_familiar_inc_edif=%11$s, combinado_familiar_rc_lind=%12$s, combinado_familiar_cristales=%13$s, combinado_familiar_responsabilidad_civil=%14$s, combinado_familiar_danios_agua=%15$s, combinado_familiar_jugadores_golf=%16$s, combinado_familiar_inc_edif_flag=%17$s, combinado_familiar_rc_lind_flag=%18$s, combinado_familiar_tv_aud_vid_flag=%19$s, combinado_familiar_obj_esp_prorrata_flag=%20$s, combinado_familiar_equipos_computacion_flag=%21$s, combinado_familiar_cristales_flag=%22$s, combinado_familiar_responsabilidad_civil_flag=%23$s, combinado_familiar_danios_agua_flag=%24$s, combinado_familiar_jugadores_golf_flag=%25$s, combinado_familiar_film_foto_flag=%26$s, combinado_familiar_inc_mob=%27$s, combinado_familiar_inc_mob_flag=%28$s, combinado_familiar_id=LAST_INSERT_ID(combinado_familiar_id)',
									$poliza_id,												
									...
									GetSQLValueString(isset($_POST['box-combinado_familiar_rc_lind_flag']) ? 'true' : '', 'defined','1','0'),
