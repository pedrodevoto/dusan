...
CREATE TABLE `automotor` (
  ...
  `franquicia` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `automotor_general_archivo`;
CREATE TABLE `automotor_general_archivo` (
  `automotor_general_archivo_id` int(11) NOT NULL AUTO_INCREMENT,
  `automotor_id` int(10) unsigned DEFAULT NULL,
  `automotor_general_archivo_url` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `automotor_general_archivo_nombre` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`automotor_general_archivo_id`),
  KEY `automotor_id` (`automotor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `caja_diaria` (
  ...
  `caja_diaria_numero` int(11) NOT NULL,
  PRIMARY KEY (`caja_diaria_id`),
  UNIQUE KEY `caja_diaria_fecha_sucursal_id` (`caja_diaria_fecha`,`sucursal_id`),
  UNIQUE KEY `caja_diaria_numero_sucursal_id` (`caja_diaria_numero`,`sucursal_id`),
...
CREATE TABLE `cliente` (
  ...
  `cliente_sms_deuda` tinyint(4) DEFAULT '1',
  `cliente_sms_registro` tinyint(4) DEFAULT '1',
  `cliente_sms_cumpleanos` tinyint(4) DEFAULT '1',
  `cliente_sms_newsletter` tinyint(4) DEFAULT '1',
...
CREATE TABLE `contacto` (
  ...
  `contacto_telefono2` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `cuota` (
  ...
  CONSTRAINT `cuota_ibfk_3` FOREIGN KEY (`poliza_id`) REFERENCES `poliza` (`poliza_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `evento` (
  ...
  `evento_titulo` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `evento_descripcion` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `libros_rubricados_rcr` (
  ...
  `libros_rubricados_rcr_polizas` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `poliza` (
  ...
  `poliza_cobranza_domicilio` tinyint(3) unsigned NOT NULL DEFAULT '0',
  ...
  KEY `sucursal_id` (`sucursal_id`),
  KEY `poliza_renueva_num` (`poliza_renueva_num`),
  CONSTRAINT `poliza_ibfk_1` FOREIGN KEY (`subtipo_poliza_id`) REFERENCES `subtipo_poliza` (`subtipo_poliza_id`),
  CONSTRAINT `poliza_ibfk_10` FOREIGN KEY (`productor_seguro_id`) REFERENCES `productor_seguro` (`productor_seguro_id`) ON DELETE CASCADE,
  CONSTRAINT `poliza_ibfk_11` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`cliente_id`) ON DELETE CASCADE,
