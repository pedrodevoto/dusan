...
<?php
	...
	$query_Recordset1_fields = " seguro_cobertura_tipo_id, seguro_cobertura_tipo.seguro_id, seguro_cobertura_tipo_nombre, seguro_nombre, seguro_cobertura_tipo_limite_rc_valor, seguro_cobertura_tipo_gruas, CONCAT(IFNULL(seguro_cobertura_tipo_anios_de, ''), ' - ', IFNULL(seguro_cobertura_tipo_anios_a, '')) as seguro_cobertura_tipo_anios_de_a";
	$query_Recordset1_tables = " FROM seguro_cobertura_tipo JOIN seguro ON seguro_cobertura_tipo.seguro_id = seguro.seguro_id LEFT JOIN seguro_cobertura_tipo_limite_rc ON seguro_cobertura_tipo_limite_rc.seguro_cobertura_tipo_limite_rc_id = seguro_cobertura_tipo.seguro_cobertura_tipo_limite_rc_id ";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('seguro_cobertura_tipo_id', 'seguro_id', 'seguro_cobertura_tipo_nombre', 'seguro_nombre', 'seguro_cobertura_tipo_limite_rc_valor', 'seguro_cobertura_tipo_gruas', 'seguro_cobertura_tipo_anios_de_a', ' ');
