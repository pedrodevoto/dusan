...
<?php
	...
	$query_Recordset1_fields = " endoso_id, poliza_numero, CONCAT(endoso_tipo_grupo_nombre, ' (', endoso_tipo_nombre, ')') as endoso_tipo, cliente_nombre, sucursal_nombre, DATE_FORMAT(endoso_fecha_pedido, '%d/%m/%y') as endoso_fecha_pedido, IF(endoso_completo = 1, 'SÍ', 'NO') as endoso_completo";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('endoso_id', 'poliza_numero', 'endoso_tipo', 'cliente_nombre', 'sucursal_nombre', 'endoso_fecha_pedido', 'endoso_completo', ' ');
