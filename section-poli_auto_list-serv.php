...
<?php
	...
	if(isset($_GET['patente']) && $_GET['patente']!=""){	
		$query_Recordset1_where .= sprintf(" AND CONCAT(patente_0, patente_1) LIKE %s",GetSQLValueString('%' . $_GET['patente'] . '%', "text"));
	}
