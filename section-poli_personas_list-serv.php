...
<?php
	...
	$query_Recordset1_where = " WHERE poliza_archivada IS NULL AND tipo_poliza_id = 3 AND poliza.subtipo_poliza_id != 6";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('poliza_id', 'cliente_id', 'poliza_numero', 'subtipo_poliza_nombre', 'seguro_nombre', 'sucursal_nombre', 'productor_nombre', 'cliente_nombre', 'poliza_vigencia', 'poliza_validez_desde', 'poliza_validez_hasta', 'poliza_estado_entrega', 'poliza_estado_nombre', 'poliza_al_dia', 'poliza_al_dia_detalle', ' ');
