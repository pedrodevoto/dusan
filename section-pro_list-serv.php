...
<?php
	...
	$query_Recordset1_fields = " productor.productor_id, productor_nombre, productor_iva, productor_cuit, productor_matricula, productor_email";
	$query_Recordset1_tables = " FROM productor";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('productor_id', 'productor_nombre', 'productor_iva', 'productor_cuit', 'productor_matricula', 'productor_email', ' ');
	
			/* Indexed column (used for fast and accurate table cardinality) */
			$sIndexColumn = "productor.productor_id";		
