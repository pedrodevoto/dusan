...
<?php
	...
	$query_Recordset1_fields = " zona_riesgo_id, zona_riesgo_nombre";
	$query_Recordset1_tables = " FROM zona_riesgo";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('zona_riesgo_id', 'zona_riesgo_nombre', ' ');
	
			/* Indexed column (used for fast and accurate table cardinality) */
			$sIndexColumn = "zona_riesgo_id";		
