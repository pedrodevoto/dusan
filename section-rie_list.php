...
<html>
	<head>
		...
		<title>JARVIS - Zonas de riesgo - Listado</title>
			...
			$(document).ready(function() {		
				...
				oTable = $('#table1').dataTable({	
					...
					"aoColumns": [	
						...
						null,						
						{"bSearchable": false, "bSortable": false, "fnRender": function (oObj) { return '<ul class="dtInlineIconList ui-widget ui-helper-clearfix"><li title="Modificar" onclick="openBoxModZonaRiesgo('+oObj.aData[0]+');"><span class="ui-icon ui-icon-pencil"></span></li></ul>'; }}
					],	
					"aaSorting": [[1,'asc']],					
