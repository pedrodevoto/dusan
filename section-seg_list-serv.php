...
<?php
	...
	$query_Recordset1_fields = " seguro.seguro_id, seguro_nombre, seguro_email_siniestro, seguro_email_emision";
	$query_Recordset1_tables = " FROM seguro";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('seguro_id', 'seguro_nombre', 'seguro_email_siniestro', 'seguro_email_emision', ' ');
	
			/* Indexed column (used for fast and accurate table cardinality) */
			$sIndexColumn = "seguro.seguro_id";		
