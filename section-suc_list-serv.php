...
<?php
	...
	$query_Recordset1_fields = " sucursal.sucursal_id, sucursal_nombre, sucursal_direccion, sucursal_telefono, sucursal_email";
	$query_Recordset1_tables = " FROM sucursal";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('sucursal_id', 'sucursal_nombre', 'sucursal_direccion', 'sucursal_telefono', 'sucursal_email', ' ');
	
			/* Indexed column (used for fast and accurate table cardinality) */
			$sIndexColumn = "sucursal.sucursal_id";		
