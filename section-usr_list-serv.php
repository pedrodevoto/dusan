...
<?php
	...
	$query_Recordset1_fields = " usuario.usuario_id, usuario_acceso, usuario_nombre, usuario_usuario, usuario_email";
	$query_Recordset1_tables = " FROM usuario";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('usuario_id', 'usuario_acceso', 'usuario_nombre', 'usuario_usuario', 'usuario_email', ' ');
	
			/* Indexed column (used for fast and accurate table cardinality) */
			$sIndexColumn = "usuario.usuario_id";		
