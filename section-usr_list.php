...
<html>
	<head>
		...
		<title>JARVIS - Usuarios - Listado</title>
			...
			$(document).ready(function() {		
				...
				oTable = $('#table1').dataTable({	
					...
					"aoColumns": [	
						...
						null,
						null,
						{"bSearchable": false, "bSortable": false, "fnRender": function (oObj) { return '<ul class="dtInlineIconList ui-widget ui-helper-clearfix"><li title="Modificar" onclick="openBoxModUsuario('+oObj.aData[0]+');"><span class="ui-icon ui-icon-pencil"></span></li><li title="Eliminar" onclick="deleteViaLink(\'usuario\','+oObj.aData[0]+');"><span class="ui-icon ui-icon-trash"></span></li></ul>'; }}
					],	
