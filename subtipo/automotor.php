...
<!--
	...
	$('#box-automotor_modelo_id, #box-ano').change(function() {
...
<form name="frmBox" id="frmBox" class="frmBoxMain" style="margin-top:20px" enctype="multipart/form-data">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">    
		...
		<div style="float:left;width:50%">
		    <p>
		        <label for="box-ano">Año de fabricación *</label>
			...
			<p>
				...
				<select id="box-automotor_modelo_id" name="box-automotor_modelo_id" class="ui-widget-content required" style="width:223px">
					
				</select>
			</p>
			<p>
				<label for="box-automotor_version_id">Versión</label>
				<select id="box-automotor_version_id" name="box-automotor_version_id" class="ui-widget-content" style="width:223px">
	...
	<fieldset class="ui-widget ui-widget-content ui-corner-all" style="margin-top:10px">    
		...
		<div style="float:left;width:50%">
		    ...
		    <p>
		        ...
		        <input type="text" name="box-franquicia" id="box-franquicia" maxlength="50" class="ui-widget-content" style="width:120px" readonly="readonly" />
		    </p>    
		    <p>
