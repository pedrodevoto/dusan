<form name="frmBox" id="frmBox" class="frmBoxMain" style="margin-top:20px">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">
		...
		<p>
			<label for="box-incendio_edificio_country" style="width:200px">Barrio Cerrado / Country </label><input type="checkbox" name="box-incendio_edificio_country" id="box-incendio_edificio_country" />
		</p>
		<p>
			<label for="box-incendio_edificio_lote" style="width:200px">Lote </label><input type="checkbox" name="box-incendio_edificio_lote" id="box-incendio_edificio_lote" />
		</p>
		<p>
			<label for="box-incendio_edificio_valor_tasado" style="width:200px">Valor tasado de la propiedad</label><input type="number" name="box-incendio_edificio_valor_tasado" id="box-incendio_edificio_valor_tasado" placeholder="Opcional" class="ui-widget-content" />
		</p>
		<p>
			<label for="box-incendio_edificio_suma_asegurada" style="width:200px">Suma asegurada *</label><input type="number" name="box-incendio_edificio_suma_asegurada" id="box-incendio_edificio_suma_asegurada" maxlength="255" class="ui-widget-content required" style="width:200px" />
		</p>
		<p>
			<label for="box-incendio_edificio_prorrata" style="width:200px">Prorrata</label><input type="number" min="0" max="100" name="box-incendio_edificio_prorrata" id="box-incendio_edificio_prorrata" maxlength="10" class="ui-widget-content" style="width:50px" /> %
		</p>
	</fieldset>
</form>