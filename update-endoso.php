...
<?php
	if ((isset($_POST["box-endoso_id"])) && ($_POST["box-endoso_id"] != "")) {	
		...
		// Update
		$updateSQL = sprintf("UPDATE endoso SET endoso_fecha_pedido=%s, endoso_tipo_id=%s, endoso_cuerpo=TRIM(%s), endoso_numero=TRIM(%s), endoso_fecha_compania=%s, endoso_completo=%s WHERE endoso_id=%s LIMIT 1",
